...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionScaffold_free = new QAction(MainWindow);
        ...
        menuDesign->setObjectName(QStringLiteral("menuDesign"));
        ...
        menuDesign->addAction(actionAtrail);
        menuDesign->addAction(actionScaffold_free);
        menuDesign->addAction(actionSpanning_tree);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionAutofill_strands->setText(QApplication::translate("MainWindow", "Autofill staple strand gaps", Q_NULLPTR));
        ...
        actionAtrail->setText(QApplication::translate("MainWindow", "A-trail", Q_NULLPTR));
        ...
        menuDesign->setTitle(QApplication::translate("MainWindow", "Design", Q_NULLPTR));
