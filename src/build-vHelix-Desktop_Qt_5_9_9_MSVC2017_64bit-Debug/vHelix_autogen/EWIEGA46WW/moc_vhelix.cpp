...
QT_MOC_LITERAL(9, 66, 3) // "arg"

    },
    "vHelix\0sendToConsole_\0\0std::string\0"
    "msg\0readMesh_\0mesh\0action_\0cmd\0arg"
};
...
void vHelix::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->action_((*reinterpret_cast< std::string(*)>(_a[1])),(*reinterpret_cast< std::string(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (vHelix::*_t)(std::string );
