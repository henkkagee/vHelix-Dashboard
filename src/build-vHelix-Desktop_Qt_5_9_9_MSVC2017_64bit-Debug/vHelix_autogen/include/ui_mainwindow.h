...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tab_3->setMinimumSize(QSize(750, 0));
        tabWidget->addTab(tab_3, QString());
        tab_4 = new QWidget();
        tab_4->setObjectName(QStringLiteral("tab_4"));
        sizePolicy2.setHeightForWidth(tab_4->sizePolicy().hasHeightForWidth());
        tab_4->setSizePolicy(sizePolicy2);
        tab_4->setMinimumSize(QSize(750, 0));
        tabWidget->addTab(tab_4, QString());

        horizontalLayout->addWidget(tabWidget, 0, Qt::AlignRight);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionExport_selection->setText(QApplication::translate("MainWindow", "Export selection", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("MainWindow", "Mode 1", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("MainWindow", "Mode 2", Q_NULLPTR));
