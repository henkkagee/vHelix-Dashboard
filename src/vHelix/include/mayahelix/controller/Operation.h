...
namespace Helix {
	namespace Controller {
		...
		protected:
			...
			virtual std::string doExecute(ElementT & element) = 0;
			virtual std::string doUndo(ElementT & element, UndoDataT & undoData) = 0;
			virtual std::string doRedo(ElementT & element, RedoDataT & redoData) = 0;
