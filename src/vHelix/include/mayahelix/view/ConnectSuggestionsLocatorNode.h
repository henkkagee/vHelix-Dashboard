...
namespace Helix {
	namespace View {
		...
		public:
			...
			friend std::string ConnectSuggestionsLocatorNode_GetScale(const std::vector<double> & u, const std::vector<double> & near_p, BasePair & bases, double & scale_, double & distance_);
		...
		protected:
			...
			static std::string UpdateBase(Model::Base & base);
			...
			static inline std::string UpdateHelix(Model::Helix & helix) {
			...
			static std::string UpdateTransform(Model::Object & object);
