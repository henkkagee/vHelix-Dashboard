...
namespace Helix {
	...
	public:
		...
		static std::string registerOnSelectionChangedListener();
		static std::string deregisterOnSelectionChangedListener();
		static std::string recursiveSearchForNeighbourBases(MDagPath dagPath, MObject forward_attribute, MObject backward_attribute, MDagPathArray endBases, bool force = false);
	};
}*/
